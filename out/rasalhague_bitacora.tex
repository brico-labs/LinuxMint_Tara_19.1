...
Añadimos
\href{https://trac.osgeo.org/ubuntugis/wiki/UbuntuGISRepository}{UbuntuGIS}
a nuestras fuentes de software. Creamos el fichero
\texttt{/etc/apt/sources.list.d/ubuntugis.list} que contiene la linea:
